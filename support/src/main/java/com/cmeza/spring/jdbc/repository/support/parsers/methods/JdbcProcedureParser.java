...
public class JdbcProcedureParser implements IParser<JdbcProcedure, JdbcProcedureProperties> {
    private static final Parser parser = Parser.getInstance();

    @Override
    public void parse(JdbcProcedure annotation, JdbcProcedureProperties dslProperty) {
