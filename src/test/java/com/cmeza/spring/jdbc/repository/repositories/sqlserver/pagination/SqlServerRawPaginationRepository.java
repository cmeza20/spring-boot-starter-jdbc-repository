package com.cmeza.spring.jdbc.repository.repositories.sqlserver.pagination;
...
public interface SqlServerRawPaginationRepository extends PaginationContract {
    @Override
