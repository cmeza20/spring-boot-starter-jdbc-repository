...
public abstract class AbstractQueryTest extends AbstractException implements QueryTestContract {
    ...
    @Test
    @Override
    public void testGetAllEmployeeHarcoded() {
        AssertUtils.assertCollection(queryRepository.getAllEmployeeHarcoded(), 100);
    }
    ...
    public void testGetBirtdateEmployeeWithCondition() {
        ...
        Date birtdate = queryRepository.getBirtdateEmployeeWithCondition(idEmployee);
