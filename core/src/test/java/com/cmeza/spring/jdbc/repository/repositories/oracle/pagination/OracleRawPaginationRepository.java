...
public interface OracleRawPaginationRepository extends PaginationContract {
    @Override
    @JdbcRawPagination(value = "select * from test.employee")
    JdbcPage<Employee> paginationEmployeesWithoutParameter();

    @Override
    @JdbcRawPagination(value = "select * from test.employee where id = :id")
    JdbcPage<Employee> paginationEmployeesWithCondition(Integer id);

    @Override
    @JdbcRawPagination(value = "select * from test.employee where id between :from and :to")
    ...
    @JdbcRawPagination(value = "select * from test.employee where id <= :max")
